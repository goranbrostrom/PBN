...
Dagens match går mot *Kamraterna*, detta är andra halvlek från den 22 oktober 2015 (som en prototyp).
...
##pbn <- readRes("2015-10-15a.pbn")  # Obsolete?
boards <- parse_pbn("2015-10-22b.pbn") # Change as needed
NS <- "Kalle & Micke (NS)"
